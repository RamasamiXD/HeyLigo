...
function sort_by_time(){
    ...
    $.ajax({
		...
		console.log(top_searches[0]);
            $('#RelatedPost').empty();
            for (index = 0; index < top_searches.length; ++index){
                $('#RelatedPost').append("<a  target='_blank' style='background-color: "+top_searches[index][4]+";' class='list-group-item' href='"+top_searches[index][6]+"'><h4 class='list-group-item-heading title_tag'>"+top_searches[index][1]+"</h4><p class='list-group-item-text'></p>"+top_searches[index][2]+"<p class='list-group-item-text'></p>"+top_searches[index][5]+"<p class='list-group-item-text date_tag'>"+top_searches[index][3]+"</p></a>")
            }
            var i = 0;
            ...
            for (var key in author_titles){
                ...
                for (index = 0; index < author_titles[key].length; ++index){
                    t+="<a target='_blank' style='background-color: "+author_titles[key][index][4]+";'  class='list-group-item' href='"+author_titles[key][index][6]+"'><h4 class='list-group-item-heading title_tag'>"+author_titles[key][index][1]+"</h4><p class='list-group-item-text date_tag'>"+author_titles[key][index][3]+"</p></a>";
                }
