        ...
        if(data.results){
            ...
            if (images.length>0){
                ...
                for (index = 0; index < images.length; ++index) {
                    ...
                    $('#img').append("<a target='_blank' href=' https://logbook.virgo-gw.eu/virgo/?r="+images[index][1]+"'><img src='https://logbook.virgo-gw.eu/virgo/"+images[index][0]+"' onmouseout='Out()' onmouseover='"+func_str+"' height='60px' width='60px'></a>")
            ...
            $('#RelatedPost').empty();
                ...
                $('#RelatedPost').append("<a  target='_blank' style='background-color: "+top_searches[index][4]+";'  class='list-group-item' href=' https://logbook.virgo-gw.eu/virgo/?r="+top_searches[index][0]+"'><h4 class='list-group-item-heading title_tag'>"+top_searches[index][1]+"</h4><p class='list-group-item-text'></p>"+top_searches[index][2]+"<p class='list-group-item-text'></p>"+top_searches[index][5]+"<p class='list-group-item-text date_tag'>"+top_searches[index][3]+"</p></a>")
            }
            var i = 0;
            ...
            for (var key in author_titles){
                ...
                for (index = 0; index < author_titles[key].length; ++index){
                    t+="<a  target='_blank' style='background-color: "+author_titles[key][index][4]+";'  class='list-group-item' href=' https://logbook.virgo-gw.eu/virgo/?r="+author_titles[key][index][0]+"'><h4 class='list-group-item-heading title_tag'>"+author_titles[key][index][1]+"</h4><p class='list-group-item-text date_tag'>"+author_titles[key][index][3]+"</p></a>";
                }
